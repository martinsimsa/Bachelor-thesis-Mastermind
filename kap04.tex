...
Tento postup byl implementován v jazyce Python pro účel této práce. Zdrojový kód s dokumentací je k této práci přiložen (Příloha A.1). Dále je dostupný na~GitHub \cite{Simsa_Strategies_for_Mastermind_2025}. 
