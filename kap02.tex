...
\begin{figure}[h!]
    ...
    \node (1) at (0,0) {\{1,2\}};
    \node (2) at (-3,-4) {\{1\}};
    \draw[->] (1) to[out=-120, in=90]  node[midway, below, sloped] {\footnotesize$(1,(1,0))$} (2);
    \draw[->] (1) to[out=-90, in=30] node[pos=0.5, below, sloped] {\footnotesize$(2,(0,0))$} (2);
    
    % \draw[->] (2) to[out=180, in=150] node[pos=0.5, below, sloped] {\footnotesize$(1,(1,0))$} (2);
    % \draw[->] (2) to[out=180, in=-150] node[pos=0.5, below, sloped] {\footnotesize$(2,(0,0))$} (2);
    ...
    \node (4) at (0,-8) {$\emptyset$};
    \draw[->] (2) to[out=-30, in=90] node[pos=0.5, above, sloped] {\footnotesize$(1,(0,0))$} (4) ;
    \draw[->] (2) to[out=-60, in=150] node[pos=0.5, above, sloped] {\footnotesize$(2,(1,0))$} (4);

    \draw[->] (3) to[out=-120, in=90]  node[midway, below, sloped] {\footnotesize$(1,(1,0))$} (4);
    \draw[->] (3) to[out=-90, in=30] node[pos=0.5, below, sloped] {\footnotesize$(2,(0,0))$} (4);
    ...
    \path[->] (2) edge [loop left] node {\footnotesize$(1,(1,0))$} ()
              ...
              (4) edge [loop below] node {\footnotesize$\{1,2\} \times \{(1,0), (0,0)\}$} ()
    ;
    \end{tikzpicture}
