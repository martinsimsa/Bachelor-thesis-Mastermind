...
Pro $w$ liché kódy zvolíme následovně:
\[
  u = 
    \underbrace{11\dots1}_{b}
...
Nechť $n \in \N $, $k \in \N$. [n,k]-Mastermind je hra pro dva hráče, zadavatele a luštitele, 
...
\begin{enumerate}
    ...
    \item Hra dále probíhá po kolech $i = 1,2,3,\dots$
        \begin{enumerate}
            \item Luštitel určí kód (tah, pokus) $u_i \in H_{n,k}$.
...
\end{enumerate}
Cílem hry [n,k]-Mastermind je nalézt tajný kód na co nejmenší počet pokusů. V případě, že luštitel neopakuje kódy v pokusech, hra jistě skončí.
