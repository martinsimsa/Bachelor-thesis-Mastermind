...
\end{tvrz}
\begin{dukaz}
    Jednoznačnost řešení plyne z předpisu valuace a strategie a z jednoznačnosti ohodnocení. Dále dokážeme, že v každém kroku algoritmu se zmenší velikost množiny kandidátů aktuálního stavu, a tedy algoritmus skončí. Nechť $K$ je množina kandidátů obsahující alespoň dva kódy. Nechť $u \in K$. Potom $|K_{u,(n,0)}| = 1$, a tedy 
    \[|\bigsqcup_{r\in S, r \neq (n,0)} K_{u,r} | = |K| - 1.\]
