...
Zdrojový kód v jazyce Python pro testování algoritmů je přiložen elektronicky jako samostatný soubor \texttt{mastermind-testing-algorithm.py}. Použitá verze Pythonu je 3.10.9.

\section{Dokumentace.pdf}\label{priloha-dokumentace}
Dokumentace k programu \texttt{mastermind-testing-algorithm.py} je přiložena elektronicky jako samostatný soubor ve formátu PDF/A. Obsahuje návod k použití programu a vysvětlení použitých funkcí. 
