...
\section{Mastermind-testing-algorithm.py}\label{priloha-program}
Zdrojový kód program pro testování algoritmů je přiložen jako samostatný soubor \texttt{Mastermind-testing-algorithm.py}. Použitý formát je prostý text (UTF-8). Použitá verze Pythonu je Python 3.10.9.

\section{Dokumentace.pdf}\label{priloha-dokumentace}
Dokumentace k programu \texttt{Mastermind-testing-algorithm.py} je přiložena jako samostatný soubor ve formátu PDF/A. Obsahuje návod k použití programu a vysvětlení použitých funkcí. 
