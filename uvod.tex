...
% Ukázalo se, že nelze zaručit nalezení tajného kódu na čtyři tahy \cite{koyama}. Knuthův algoritmus je tedy optimální z hlediska maximálního počtu tahů. Déle však trvalo nalézt optimální strategii z hlediska průměrného počtu tahů k nalezení tajného kódu. 
